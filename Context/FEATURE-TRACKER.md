...
| **Go-live spin countdown lock** (unlock Wed 16 Sep 09:00) | 🔨 | BRIEF-019 built (v=25) on `feat/spin-countdown` — countdown over the blurred real Spin screen; admins bypass, `?preview=1` for QA; auto-lifts, no redeploy |
| Prize amounts on leaderboard card (€250 / €250 / €150 + money icon) | 📋 | BRIEF-018 — Donnae's confirmed amounts; small |
