...
| Admin: surface captured answers + real export | 🔨 | BRIEF-007 built (v=19) on `feat/admin-answers-export` — idea bank with real counts + answers, anonymise toggle, CSV export. **No rules change needed** (admin read already published) |
