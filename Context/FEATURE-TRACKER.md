...
| **Multilingual EN/NL/RO** (picker, translated questions, core UI, language badge) | 🔨 | BRIEF-023 built (v=38) on `feat/multilingual` — **needs the admin dashboard opened once to reseed (SEED_VERSION 3)**; NL/RO wording pending native review |
